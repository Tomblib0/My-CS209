        ...
        if (Objects.equals(c.getNumber(), key)) {
          if (Integer.parseInt(latest_date[2]) < Integer.parseInt(c.getLaunchDate()[2])) {
            ...
            l_csm = c.getTitle();
              ...
              Integer.parseInt(latest_date[2]) == Integer.parseInt(c.getLaunchDate()[2])
                            && Integer.parseInt(latest_date[0]) < Integer.parseInt(
                            c.getLaunchDate()[0])) {
            latest_date = c.getLaunchDate();
            l_csm = c.getTitle();
          } else if (
              Integer.parseInt(latest_date[2]) == Integer.parseInt(c.getLaunchDate()[2])
                            && Integer.parseInt(latest_date[0]) == Integer.parseInt(
                            c.getLaunchDate()[0])
                            && Integer.parseInt(latest_date[1]) < Integer.parseInt(
                            c.getLaunchDate()[1])) {
            latest_date = c.getLaunchDate();
            l_csm = c.getTitle();
          }
